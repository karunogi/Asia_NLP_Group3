...
##### 담당 : 김주희 ( 서경대학교 / 산업경영시스템공학과 )<br></br>
##### email : zuhigogo96@gmail.com

## 기획의도
'드라이브갈 때 듣기 좋은 신나는 여름 노래 추천해줘', '카페에서 듣기 좋은 잔잔한 재즈 추천해줘' 와 같이 사용자의 취향에 맞는 음악 특성에 따라 음악을 추천해주는 챗봇을 구현하고자 하였습니다. 장르외의 특성을 파악하기 위해 벅스의 음악추천 카테고리에서 분류된 태크 데이터로 사용자의 취향에 맞는 음악을 추천해주는 모델을 만들고자 하였습니다.
